...
dwr.engine._origScriptSessionId = "4C76E0D5E11A15CBB9B329B180A61ADB";
...
dwr.engine._defaultPath = "/onki-yso/dwr";
...
// set the communication method to "script tag" to enable the cross-domain communication 
...
//dwr.engine.setExceptionHandler(errorHandler);
//dwr.engine.setWarningHandler(errorHandler);
